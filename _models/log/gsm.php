...
class mdl_log_gsm extends ujn_model {
	...
	function ParseGpsToAddressLog($latitude,$longitude,$imei,$AddressZH){
		$sql="INSERT INTO `swt_gps_parse_log` (`imei`,`latitude`,`longitude`,`address`)VALUES('$imei',$latitude,$longitude,'$AddressZH')";
		$this->_db->query($sql);
	}
	...
	function ParseGsmToGpsLog($imei,$cellId,$locationAreaCode,$mobileCountryCode,$mobileNetworkCode,$latitude,$longitude,$AddressZH){
		$sql="INSERT INTO `swt_gsm_station_parse_log`(`imei`,`cell_code`,`location_area_code`,`mobile_country_code`,`mobile_network_code`,`latitude`,`longitude`,`address`)VALUES('$imei',$cellId,$locationAreaCode,$mobileCountryCode,$mobileNetworkCode,$latitude,$longitude,'$AddressZH')";
		$this->_db->query($sql);
	}
